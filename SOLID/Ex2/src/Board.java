...
public class Board {
    public static void main(String[] args) {
        ...
        PolicyResolver resolver = new PolicyResolver(
            Map.of(
                "student", new CustomerPolicy(new StudentTaxPolicy(), new StudentDiscountPolicy()),
                "staff",   new CustomerPolicy(new StaffTaxPolicy(),   new StaffDiscountPolicy())
            ),
            new CustomerPolicy(new DefaultTaxPolicy(), new DefaultDiscountPolicy())
        );
